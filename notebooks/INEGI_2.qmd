...
```{r}
dag_a = empty.graph(nodes = c(disc_cols, cont_cols))
dag_b = dag_a
dag_c = dag_a
```
...
```{r}
scores <- c(
  dag_a = score(dag_a, data = data, type = "bic-cg"),
  dag_b = score(dag_b, data = data, type = "bic-cg"),
  dag_c = score(dag_c, data = data, type = "bic-cg"),
  dag = score(dag, data = data, type = "bic-cg")
)
